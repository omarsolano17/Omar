...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            UPDATE NOTI SET FECHA_NOTIFICA=@FECHA_NOTI, NOTIFICACION = @NOTIFICACION, SMS = @SMS, WHATSAPP = @WHATSAPP, CORREO = @CORREO,
                          NUMERO = @NUMERO, EMAIL = @EMAIL, API_WHATSAPP = @API_WHATSAPP1, AVISARDESDE = @AVISARDESDE, TIPOAVISO = @TIPOAVISO
            WHERE ID = @ID
